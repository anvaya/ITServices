<?php
/**
 * Description of backendMemberForm
 *
 * @author Mrugendra Bhure
 */
class backendMemberForm  extends sfGuardUserAdminForm
{
    /**
     * @see sfGuardUserForm
     */
    public function configure()
    {
        ...
        $in_address = $addressTable->createQuery('aa')
                        ->addWhere('member_id = ?', $id)
                        ->addWhere('address_type = ?', addressTable::ADDRESS_TYPE_IND)
                        ->fetchOne();
        ...
        $nri_address = $addressTable->createQuery('aa')
                        ->addWhere('member_id = ?', $id)
                        ->addWhere('address_type = ?', addressTable::ADDRESS_TYPE_NRI)
                        ->fetchOne();
