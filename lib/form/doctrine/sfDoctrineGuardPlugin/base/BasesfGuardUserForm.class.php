...
abstract class BasesfGuardUserForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'is_member'            => new sfWidgetFormInputText(),
      'member_type_id'       => new sfWidgetFormInputText(),
      ...
      'occupation_type'      => new sfWidgetFormInputText(),
      'job_title'            => new sfWidgetFormInputText(),
      'industry'             => new sfWidgetFormInputText(),
      'other_income_source'  => new sfWidgetFormInputText(),
      'married'              => new sfWidgetFormInputCheckbox(),
      'gender'               => new sfWidgetFormChoice(array('choices' => array('M' => 'M', 'F' => 'F'))),
      'marriage_anniversary' => new sfWidgetFormDate(),
      'year_as_nri'          => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'is_member'            => new sfValidatorInteger(array('required' => false)),
      'member_type_id'       => new sfValidatorInteger(array('required' => false)),
      ...
      'occupation_type'      => new sfValidatorInteger(array('required' => false)),
      ...
      'married'              => new sfValidatorBoolean(array('required' => false)),
      'gender'               => new sfValidatorChoice(array('choices' => array(0 => 'M', 1 => 'F'), 'required' => false)),
      'marriage_anniversary' => new sfValidatorDate(array('required' => false)),
      'year_as_nri'          => new sfValidatorInteger(array('required' => false)),
