...
/**
 * blog_tag form base class.
 *
 * @method blog_tag getObject() Returns the current form's model object
 *
 * @package    BestBuddies
 * @subpackage form
 ...
 */
abstract class Baseblog_tagForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'blog_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('blog'), 'required' => false)),
