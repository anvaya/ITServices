...
/**
 * submission_inner_data form base class.
 *
 * @method submission_inner_data getObject() Returns the current form's model object
 *
 * @package    BestBuddies
 * @subpackage form
 ...
 */
abstract class Basesubmission_inner_dataForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id'                  => new sfWidgetFormInputHidden(),
      'submission_inner_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('submission_inner'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'submission_inner_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('submission_inner'))),
    ...
    $this->widgetSchema->setNameFormat('submission_inner_data[%s]');
