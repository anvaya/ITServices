...
abstract class BaseproductForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'billing_unit_id' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'billing_unit_id' => new sfValidatorInteger(),
      ...
      'fy'              => new sfValidatorInteger(array('required' => false)),
    ));
