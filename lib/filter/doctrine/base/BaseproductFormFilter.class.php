...
abstract class BaseproductFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'billing_unit' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('billing_unit'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'billing_unit' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('billing_unit'), 'column' => 'id')),
