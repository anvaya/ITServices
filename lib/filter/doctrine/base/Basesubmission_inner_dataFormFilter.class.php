...
/**
 * submission_inner_data filter form base class.
 *
 * @package    BestBuddies
 * @subpackage filter
 ...
 */
abstract class Basesubmission_inner_dataFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'submission_inner_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('submission_inner'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'submission_inner_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('submission_inner'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('submission_inner_data_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      'id'                  => 'Number',
      'submission_inner_id' => 'ForeignKey',
