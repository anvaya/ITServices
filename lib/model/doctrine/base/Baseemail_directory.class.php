 ...
 * @method text            getEmailTemplate()  Returns the current record's "email_template" value
...
abstract class Baseemail_directory extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('email_subject', 'string', 100, array(
             'type' => 'string',
             'size' => 100,
             'notnull' => false,
             'length' => 100,
             ));
        $this->hasColumn('email_template', 'text', null, array(
             'type' => 'text',
             'notnull' => false,
             ));
