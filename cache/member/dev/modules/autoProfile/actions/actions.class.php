...
abstract class autoProfileActions extends sfActions
{
  ...
  public function executeNew(sfWebRequest $request)
  {
    ...
    $this->member = $this->form->getObject();
  }
  ...
  public function executeBatch(sfWebRequest $request)
  {
    ...
    $validator = new sfValidatorDoctrineChoice(array('multiple' => true, 'model' => 'member'));
    try
    {
      // validate ids
  ...
  {
    $pager = $this->configuration->getPager('member');
  ...
  {
    return Doctrine_Core::getTable('member')->hasColumn($column);
  }
}
