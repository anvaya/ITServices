...
<tr>
	<td>
		<br />
		<p>                     
                        <?php /* @var $sf_guard_user member */ ?>
                    Dear <?php echo $sf_guard_user->getQualifiedName(); ?>,
		</p>

		<p>Your PAN application has been submitted successfully to our processing desk.</p>
                
                
		<p>Please complete the bank transfer of your PAN application charges as per the details below: </p>
		<hr />
		...
		<p><b>After you have made the payment:</b></p>
                <p>&nbsp;</p>
                <p>Please click <?php echo link_to("here","@panapplication_paymentVerified?payment=$link&verify=1", array("absolute"=>true) );?> to notify us of your payment for quick processing.</p>
		<p>&nbsp;</p>
