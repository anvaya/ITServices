...
<table>
    <tbody data-bind="foreach: <?php echo $viewModelItem ?>">
        <tr data-bind="visible: errors.length == 0">
            <td valign="top" data-bind="text: $index()+1"></td>
            <td colspan="2">                
                Sold Property at "<span data-bind="text: name"></span>" for Rs.<span data-bind="text: sell_value"></span>                
            </td>            
            <td>
                <a href="#" data-bind="attr:{'onclick': 'edit_capital_item(<?php echo $itemIndex;?>,' + $index() + ')'}">
                    <?php echo  image_tag("/sfDoctrinePlugin/images/edit.png", array("title"=>"change"));?>
                </a>                
            </td>
        </tr>
        <tr data-bind="visible: errors.length > 0">
            ...
            <td>
                <table>
                        ...
                        <tr>
                            ...
                            <td>                                
                                <div data-bind="attr: {name: '<?php echo $np;?>[date_sale]'},jqxDateTimeInput: {value: date_sold, max: new Date(), disabled: false, height: '25px', width: '134px' }" />                                                                
                ...
                <table cellspacing="0" class="capital_purchase">
                    <thead>
                        <tr>
                            ...
                            <th>Amount</th>
                            <th><button class="purple-btn" data-bind="attr: {onclick: 'myViewModel.addCostsRow(<?php echo $itemIndex;?>,' + $index() + ');return false;'}">Add Row</button></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><div data-bind="attr: {name: '<?php echo $npp; ?>[date]'}, jqxDateTimeInput: {value: date, max: new Date(), disabled: false, height: '25px', width: '134px' }" /></td>
