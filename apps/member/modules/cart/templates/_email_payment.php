...
<tr>
	<td>
		...
		<p>Thank you for placing your order with us.</p>
                ...
                <p>Your Order No: <?php /* @var $order order */ echo $order->getOrderNo();  ?></p>                
		...
		<div class="payment_info">
			<table>
				...
				<tr><th align="left">Swift Code</th><td>AXISINBB048</td></tr>
                                <tr><th align="left">Amount</th><td>US $<?php echo $order->getNetAmount(); ?></td></tr>
			</table>
		</div>		
		<hr />
		<p><b>After you have made the payment:</b></p>
                <p>&nbsp;</p>
                <p>Please click <?php echo link_to("here","default/confirmPay?oid=".$order->getId(), array("absolute"=>true) );?> to notify us of your payment for quick processing.</p>
		<p>&nbsp;</p>
