...
<tr>
	<td>
		...
		<p>
                    ...
                    <?php $spouce = $user->getGender()=="M"?"wife":"husband"; $spouce_call = $user->getGender()=="M"?"her":"his"; ?>
		</p>

		<p>Thank you for renewing your subscription. Your <?php echo $spouce ?> can now renew <?php echo $spouce_call ?> subscription for just 50% charge. 
                    Just use the following coupon code at the time of renewal.
                </p>                     
                <br />
