...
<tr>
	<td>
		...
		<p>Thank you for registering with us. You are one step away from activating your account.</p>
		...
		<p><b>After you have made the payment:</b></p>
                <p>&nbsp;</p>
                <p>Please click <?php echo link_to("here","default/confirmPay?mid=".$user->getId(), array("absolute"=>true) );?> to notify us of your payment for quick processing.</p>
		<p>&nbsp;</p>
