    ...
    $.fn.bcalendar = function(option) {
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                ...
                temparr.push(i18n.xgcalendar.example, '</div><input id="bbit-cal-allday" type="hidden"/></td></tr><tr><th class="cb-key">');
                temparr.push(i18n.xgcalendar.event_start, '</th><td class="cb-value"><input id="bbit-cal-start" type="text" class="textbox-fill-input" /></div></td></tr><tr><th class="cb-key">');
                temparr.push(i18n.xgcalendar.event_end, '</th><td class="cb-value"><input id="bbit-cal-end" type="text" class="textbox-fill-input" /></div></td></tr><tr><th class="cb-key">');
                temparr.push(i18n.xgcalendar.event_type, '</th><td class="cb-value"><select id="bbit-cal-type" type="text" class="textbox-fill-input" ></select></div></td></tr><tr><th class="cb-key">');
                temparr.push(i18n.xgcalendar.event_description, '</th><td class="cb-value"><textarea id="bbit-cal-description" class="textbox-fill-input" ></textarea></div></td></tr><tr><th class="cb-key">');
                temparr.push(i18n.xgcalendar.event_address, '</th><td class="cb-value"><textarea id="bbit-cal-address" type="text"  class="textbox-fill-input" ></textarea></div></td></tr><tr><th class="cb-key">');
                temparr.push(i18n.xgcalendar.event_city, '</th><td class="cb-value"><input id="bbit-cal-city" type="text" class="textbox-fill-input" /></div></td></tr><tr><th class="cb-key">');
                temparr.push(i18n.xgcalendar.event_zip, '</th><td class="cb-value"><input id="bbit-cal-zip" type="text" class="textbox-fill-input" /></div></td></tr></tbody></table><input id="bbit-cal-quickAddBTN" value="');
                ...
                calbutton.click(function(e) {
                    ...
                    var event_type = $("#bbit-cal-type").val();
                    var event_description = $("#bbit-cal-description").val();
                    var event_address = $("#bbit-cal-address").val();
                    var event_city = $("#bbit-cal-city").val();
                    var event_zip = $("#bbit-cal-zip").val();
                    var f = /^[^\$\<\>]+$/.test(what);
                    if (!f) {
                    ...
                    { "name": "event_description", value: event_description},
                    { "name": "event_address", value: event_address},
                    { "name": "event_city", value: event_city},
                    { "name": "event_zip", value: event_zip}];
            ...
            var event_type = $.ajax({url:'eventtype',async:false}).responseText;
            $("#bbit-cal-type").html(event_type);
